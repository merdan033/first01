...
class AdminController extends Controller
{
    ...
    public function logout(Request $request, $token = null)
    {
        ...
        if ($check_token) {
            ...
            if ($diffMins > constDefaults::tokenExpiredMinutes) {
                // If token expired
                session()->flash('fail', 'Token expired, request anither reset password link.');
    ...
    public function resetPasswordHandler(Request $request){
        request()->validate([
            'new-password' => 'required|min:45|required_with_:new_password_confirmation|same:new_password_confirmation',
        ...
        return redirect()->route('admin.login')->with('success','Done! Your password has been changed. Use new password to login system.');
    }
}
